...
- [x] **9.2 Documentation**
    ...
    - [x] 9.2.3 Add `LICENSE` (open-source) and finalize `.env.example` docs. *(MIT, a reasonable default for an open-source template — easily swapped later if a different license is preferred. `.env.example` gained a short note cross-referencing `docker-compose.yml`'s optional `env_file` usage.)*
- [x] **9.3 Release**
